...
public class LessThanOrEqualRule<T extends Number> implements RuleValidator<Number>
{

    private final T paramValue;

    public LessThanOrEqualRule(T value)
    {
        paramValue = value;
    }
    ...
    public void validate(Context context, Number value, String display) throws ValidationException
    {
        ...
        throw new ValidationException(context.getString(R.string.validation_less_than_or_equal, display, paramValue));
    }
}
